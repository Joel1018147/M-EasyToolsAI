...
| Design system | `public/css/modus-design-system.css`, byte-identical to the master (md5 `edc02c0c`). **A per-repo edit to this file is a defect** (§1) — the change goes in the master and is re-copied to all twelve repos in the same commit (§1b). |
