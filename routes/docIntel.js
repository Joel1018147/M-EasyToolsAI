/* ═══════════════════════════════════════════════════════════════════════════
   Document Intelligence — LANE B
   ───────────────────────────────────────────────────────────────────────────
   FOUNDATION STUB. Mounted by server.js so that Lane B never has to edit
...
router.use((req, res) => {
  res.status(501).json({
    ...
    message: 'Document Intelligence is not built yet (Round 1, Lane B). This route is a ' +
